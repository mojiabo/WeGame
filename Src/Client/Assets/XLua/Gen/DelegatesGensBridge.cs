...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp0(UnityEngine.Transform p0, object p1)
		{
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(Framework.LuaForm.OnInitHandle))
			{
			    return new Framework.LuaForm.OnInitHandle(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(Framework.LuaForm.OnOpenHandle))
			{
			    return new Framework.LuaForm.OnOpenHandle(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(Framework.LuaForm.OnBeforeDestroyHandle))
			{
			    return new Framework.LuaForm.OnBeforeDestroyHandle(__Gen_Delegate_Imp2);
			}
